...
namespace Laura {
	...
	void Application::run()
	{
		...
		while (!m_Window->shouldClose())
		{
			...
			// if (camera.cameraKeybinds.camera_keybind_window_active) { genCameraChangeKeybindSplashScreen(); } // why the fuck is this inside the camera?
			...
			/// POST PROCESSING STAGE ///		(currently does NOTHING just returns the texture recieved from the ray tracing stage)
